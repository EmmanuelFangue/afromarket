...
namespace AfroMarket.MerchantService.Migrations
{
    ...
    [Migration("20260320022330_AddMessageThreading")]
    partial class AddMessageThreading
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AfroMarket.MerchantService.Models.Entities.Message", b =>
                {
                    ...
                    b.HasOne("AfroMarket.MerchantService.Models.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
