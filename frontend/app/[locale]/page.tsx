...
import { Search, UtensilsCrossed, ShoppingBag, Scissors, Shirt, ChefHat, ArrowRight, MapPin } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24 relative">
          <div className="max-w-3xl">
            ...
            <form onSubmit={handleSearch} className="animate-fade-in animate-delay-300">
              <div className="flex flex-col sm:flex-row gap-3 bg-card rounded-2xl p-2 shadow-xl shadow-primary/5 border border-border">
            ...
            <div className="flex flex-wrap gap-2 mt-6 animate-fade-in animate-delay-400">
              {CATEGORIES.slice(0, 3).map((cat) => (
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-card/80 hover:bg-card border border-border rounded-full text-sm font-medium text-foreground transition-colors"
          ...
          <div className="relative overflow-hidden rounded-3xl bg-primary p-8 md:p-16">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <Link
                ...
                className="whitespace-nowrap bg-card text-primary rounded-full px-8 py-4 font-semibold transition-all duration-300 hover:bg-card/90 hover:scale-[1.02] active:scale-95 shadow-lg flex items-center gap-2"
