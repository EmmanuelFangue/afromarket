...
function getCategoryIcon(name: string): React.ComponentType<{ className?: string }> {
  ...
  if (n.includes('épicerie') || n.includes('grocery')) return ShoppingBag;
  if (n.includes('coiffure') || n.includes('hair')) return Scissors;
  if (n.includes('vêtement') || n.includes('clothing')) return Shirt;
  return ChefHat;
}

const SVG_PATTERN = `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%231B4D3E' fill-opacity='0.4'%3E%3Cpath fill-rule='evenodd' d='M0 38.59l2.83-2.83 1.41 1.41L1.41 40H0v-1.41zM0 1.4l2.83 2.83 1.41-1.41L1.41 0H0v1.41zM38.59 40l-2.83-2.83 1.41-1.41L40 38.59V40h-1.41zM40 1.41l-2.83 2.83-1.41-1.41L38.59 0H40v1.41zM20 18.6l2.83-2.83 1.41 1.41L21.41 20l2.83 2.83-1.41 1.41L20 21.41l-2.83 2.83-1.41-1.41L18.59 20l-2.83-2.83 1.41-1.41L20 18.59z'/%3E%3C/g%3E%3C/svg%3E")`;
        ...
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="space-y-1">
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isActive ? 'bg-primary text-white' : 'bg-muted'}`}>
          ...
          <main className="flex-1">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6" data-testid="search-results">
